        ...
        <div id="header">
          <div id="header-inner">
            <div className='h_cont'>
              <h1>広島不用品回収（東広島、安芸区、安芸郡）・引越しゴミ・家財整理・ゴミ屋敷・遺品整理・ゴミ屋敷・空家整理</h1>
              <div className="h_logo">                
                <Link to="/"><StaticImage src="../images/logo.png" alt="安芸リサイクル" /></Link>
              </div>
              ...
              <div className="h_mail">
                <div className="pc"><Link to="/contact/" className="bt01">オンライン無料見積もり<FontAwesomeIcon icon={faCircleChevronRight} /></Link></div>
                  <span className="smp">
                    <Link to="/contact/">
