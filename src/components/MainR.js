  ...
  return (
    <>
      <div id="main_r">
        ...
        <p className="side_txt01">
          お見積もりは無料！お急ぎの方はお電話でまずはお気軽にお問い合わせください
        </p>
        ...
        <p className="center">
          <span className="sonpo">損害保険対応</span>
        </p>
      </div>
    </>
  );
