...
const Layout = ({ children }) => {
  ...
  return (
    <>
      ...
      <p id='page-top' data-sal='slide-bottom' viewOffset='0.2' data-sal-delay='200' data-sal-easing='ease'>
            ...
            <div id='main_l'>
              ...
              <div>
                <a href='tel:0120-28-3374'>
                  <StaticImage src='../images/free_dial_bt_s.png' width={765} height={200} alt='タップして電話かけてね！！tel:0120-28-3374' />
                </a>
              </div>
            </div>
