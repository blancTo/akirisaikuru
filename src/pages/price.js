    ...
    <>
      <Layout>
        ...
        <ul className="pack_list">
          <li>
            <img
              src="../images/pack_price_list01.png"
              width={143}
              height={143}
              alt=""
            />
          ...
          <li>
            <img
              src="../images/pack_price_list02.png"
              width={143}
              height={143}
              alt=""
            />
          ...
          <li>
            <img
              src="../images/pack_price_list03.png"
              width={143}
              height={143}
              alt=""
            />
          ...
          <li>
            <img
              src="../images/pack_price_list04.png"
              width={143}
              height={143}
              alt=""
            />
          ...
          <li>
            <img
              src="../images/pack_price_list05.png"
              width={143}
              height={143}
              alt=""
            />
          ...
          <li>
            <img
              src="../images/pack_price_list06.png"
              width={143}
              height={143}
              alt=""
            />
        ...
        <p>
          安芸リサイクルでは、お客様の荷物の量に合わせて「軽トラック　ハーフプラン」と「軽トラックに積み放題！プラン」と「2tトラック積み放題プラン」の3種類の料金体制をご用意しております。どのプランを選べばいいかわからない方は、まずはお気軽にお問い合わせください。ご相談から現地でのお見積もりまで、無料で行っております。
        </p>
        <h5 className="price_title" id="half">
          軽トラック ハーフプラン
        </h5>
        <p>
          <img
            src="../images/price/price01.png"
            alt="作業料金/1台 ～9,000円"
            width={660}
            height={176}
          />
        ...
        <p>1点の不用品から！</p>
        <h5 className="price_title" id="kei">
          軽トラック に積み放題！プラン
        </h5>
        <p>
          <img
            src="../images/price/price02.png"
            alt="作業料金/1台 ～19,000円"
            width={660}
            height={176}
          />
        ...
        <p>
          積み込み例：冷蔵庫、洗濯機、布団1組、3段カラーボックス、コタツ、パソコン、テレビ、ミニコンポ、レンジ、扇風機、掃除機、ダンボール（Ｌサイズ）10箱など
          <br />
          ※押入れ・クローゼット～１Ｋ程度の量
          <br />
          ※キャビンの高さまで{" "}
        ...
        <ul className="check_list">
          ...
          <li>
            <FontAwesomeIcon icon={faCheck} />
            家庭の大掃除ででたゴミや小家電を処分したい
          </li>
        </ul>

        <p>といった上記の方にオススメのプランです。</p>
        <h5 className="price_title" id="kei-horo">
          軽トラック幌車の積み放題！プラン
        </h5>
        <p>
          <img
            src="../images/price/price05.png"
            alt="作業料金/1台 ～27,000円"
            width={660}
            height={176}
          />
        ...
        <p>といった上記の方にオススメのプランです。</p>
        <h5 className="price_title" id="trak2t">
          2ｔトラック に積み放題！プラン
        </h5>
        <p>
          <img
            src="../images/price/price03.png"
            alt="作業料金/1台 ～48,000円"
            width={660}
            height={176}
          />
        ...
        <p>
          積み込み例：洗濯機、冷蔵庫、タンス、ベッドなどの大型ものももちろん、小物類、中型家具までつみ放題！
          <br />
          ※１ＤＫ～一軒家
        </p>
        ...
        <ul className="check_list">
          ...
          <li>
            <FontAwesomeIcon icon={faCheck} />
            一軒家・マンションなど一括して遺品整理を行いたい
          </li>
        </ul>

        <p>といった上記の方にオススメのプランです。</p>
        <h5 className="price_title" id="trak2tl">
          2トントラックに積み放題！Ｌパックプラン
        </h5>
        <p>
          <img
            src="../images/price/price04.png"
            alt="作業料金/1台 ～68,000円"
            width={660}
            height={176}
          />
        ...
        <p>
          家電他家具等ゴミ一緒に回収します
          <br />
          ２ＤＫ～２ＬＤＫ程度のお部屋のお片付けにオススメの定額！Ｌパックプランです。
          <br />
          ※２ＤＫ～一軒家
        </p>
      </Layout>
      ...
      itemListElement: [
        ...
        },
        {
          ...
          item: {
            ...
            description:
              "広島の不用品回収・引越しゴミ・お片付け・粗大ゴミ・お家丸ごと・遺品整理・秘密厳守・明朗会計・安心の定額パック・追加料金なし・買取から処分まで・年中無休・損害保険対応・クレジットカード対応・見積無料・遠方地域対応｜安芸リサイクルの料金プラン",
