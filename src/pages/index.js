      ...
      <section>
        <div className='main-content'>
          <div className='center pc'>
            <StaticImage src='../images/txt05.png' alt='お得な定額パックプランをご用意!!' />
          </div>
          <div className='center pc'>
            <StaticImage src='../images/txt06.png' alt='他社より1円でも高ければご相談ください!!' />
          </div>

          <TelList />

          <div className='bn_list'>
            <StaticImage src='../images/txt07.png' alt='格安回収　明朗会計　全て込み　お得なパック料金はこちら' />
          </div>
          <div className='pack_title'>下記の項目が全てパック料金に含まれます！</div>

          <ul className='pack_list'>
            <li>
              <StaticImage src='../images/pack_price_list01.png' alt='搬出作業費' />
            </li>
            <li>
              <StaticImage src='../images/pack_price_list02.png' alt='階段料金' />
            </li>
            <li>
              <StaticImage src='../images/pack_price_list03.png' alt='スタッフ追加料金' />
            </li>
            <li>
              <StaticImage src='../images/pack_price_list04.png' alt='車両費' />
            </li>
            <li>
              <StaticImage src='../images/pack_price_list05.png' alt='出張費' />
            </li>
            <li>
              <StaticImage src='../images/pack_price_list06.png' alt='エアコン取り外し' />
            </li>
          </ul>

          <p>
            安芸リサイクルでは、他社では別料金になる搬出作業費・お掃除作業費・スタッフ追加料金・車両費・出張費・エアコン取り外し費用が全て込みの料金となっております。
            <span className='dark-red b_900'>お見積り後の追加料金も一切ございません。</span>
            <br />
          ...
          <div className='kaisyu_box'>
            ...
            <StaticImage src='../images/itiran_img.png' alt='回収品一覧イメージ' className='pc' />

            <StaticImage src='../images/itiran_img_smp.png' alt='回収品一覧イメージ' className='smp' />
          </div>
          ...
          <div className='bn_list'>
            <StaticImage src='../images/txt09.png' alt='安芸リサイクルからお客様への3つのお約束！' />
          </div>

          <div className='promise_box'>
            <div className='promise_img'>
              <StaticImage src='../images/txt10_1.png' alt='即日！スピード対応！' />
            </div>
            <div className='promise_img'>
              <StaticImage src='../images/txt10_2.png' alt='損害保険に対応！' />
            </div>
            <div className='promise_img'>
              <StaticImage src='../images/txt10_3.png' alt='後から請求はありません！' />
            </div>
          </div>
          ...
          <div className='recycle_txt'>
            当社は倉庫にてリサイクル商品も販売しています。
            <br />
            家電販売　家具販売　小物類～その他生活品多数揃っています。
            <br className='pc' />
            広島で一番安いリサイクルショップ、是非一度お問い合わせください。
          </div>

          <div className='bn_list'>
            <Link to='/service/house_cleaning/'>
              <StaticImage src='../images/house-cleaning-bn.png' alt='ハウスクリーニング リフォーム担当者直通' />
            </Link>
          </div>
          ...
          <div className='flex-wrap'>
            <div id='main_l'>
              ...
              <div className='top_flow_cont'>
                <div className='top_flow_box'>
                  ...
                  <div className='top_flow_inner'>
                    <StaticImage src='../images/jirei_before01.jpg' alt='Before画像' className='img_cen' />
                ...
                <StaticImage src='../images/arrow_03.png' alt='' className='top_flow_arrow' />

                <div className='top_flow_box'>
                  <h4 className='after_title'>After</h4>
                  <div className='top_flow_inner'>
                    <StaticImage src='../images/jirei_after01.jpg' alt='After画像' className='img_cen' />
              ...
              <a href='tel:0120-28-3374'>
                <StaticImage src='../images/free_dial_bt_s.png' alt='タップして電話かけてね！！tel:0120-28-3374' />
              </a>
